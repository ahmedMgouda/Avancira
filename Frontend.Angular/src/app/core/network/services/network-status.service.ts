...
import { NETWORK_STATUS_CONFIG } from '../config/network-status.config';
import { ConnectionQuality, HealthCheckResponse, NetworkDiagnostics } from '../models/health-check.model';
