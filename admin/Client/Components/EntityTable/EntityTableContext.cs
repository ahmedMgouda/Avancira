...
public abstract class EntityTableContext<TEntity, TId, TRequest>
{
        ...
        Func<TEntity, bool>? canDeleteEntityFunc)
    {
        ...
        SearchAction = searchAction ?? AvanciraActions.Search;
        CreateAction = createAction ?? AvanciraActions.Create;
        UpdateAction = updateAction ?? AvanciraActions.Update;
        DeleteAction = deleteAction ?? AvanciraActions.Delete;
        ExportAction = exportAction ?? AvanciraActions.Export;
