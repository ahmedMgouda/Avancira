...
public partial class RolePermissions
{
    ...
    static RolePermissions() => TypeAdapterConfig<AvanciraPermission, PermissionViewModel>.NewConfig().MapToConstructor(true);

    protected override async Task OnInitializedAsync()
    {
        var state = await AuthState;

        _canEditRoleClaims = await AuthService.HasPermissionAsync(state.User, AvanciraActions.Update, AvanciraResources.RoleClaims);
            ...
            is RoleDto role && role.Permissions is not null)
        {
            ...
            var permissions = AvanciraPermissions.All;
    ...
    private async Task SaveAsync()
    {
        ...
        //var request = new UpdatePermissionsDto()
        //{
        //    RoleId = Id,
...
public record PermissionViewModel : AvanciraPermission
{
