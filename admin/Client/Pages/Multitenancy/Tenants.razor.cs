...
namespace Avancira.Admin.Client.Pages.Multitenancy;
...
public partial class Tenants
{
    ...
    protected override async Task OnInitializedAsync()
    {
        Context = new(
            ...
            entityResource: AvanciraResources.Tenants,
        ...
        _canUpgrade = await AuthService.HasPermissionAsync(state.User, AvanciraActions.UpgradeSubscription, AvanciraResources.Tenants);
        _canModify = await AuthService.HasPermissionAsync(state.User, AvanciraActions.Update, AvanciraResources.Tenants);
    }
