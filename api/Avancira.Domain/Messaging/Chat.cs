...
namespace Avancira.Domain.Messaging
{
    public class Chat : BaseEntity<Guid>, IAggregateRoot
    {
        ...
        private Chat(Guid id, string studentId, string tutorId, Guid listingId, BlockStatus blockStatus)
        {
            Id = id;
            StudentId = studentId;
            TutorId = tutorId;
        ...
        public static Chat Create(string studentId, string tutorId, Guid listingId, BlockStatus blockStatus)
        {
            return new Chat(Guid.NewGuid(), studentId, tutorId, listingId, blockStatus);
        }
